...
export default async function SettingsPage({
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      {/* Analytics Tracker - tracks Google connection */}
      <SettingsTracker googleConnected={googleConnected} />
            ...
            <div className="flex items-center">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-1.5 py-0.5 bg-blue-100 text-blue-600 rounded text-xs font-medium">NEW</span>
                </div>
                <p className="text-sm text-gray-500">
                  {isGoogleConnected
            ...
            <div className="flex items-center">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-1.5 py-0.5 bg-purple-100 text-purple-600 rounded text-xs font-medium">COMING SOON</span>
                </div>
                <p className="text-sm text-gray-500">Generate SEO-optimized titles, descriptions, and content</p>
              </div>
            </div>
            <span className="text-sm text-gray-400 bg-gray-100 px-3 py-1.5 rounded-full">Coming soon</span>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-1.5 py-0.5 bg-green-100 text-green-600 rounded text-xs font-medium">COMING SOON</span>
                </div>
                <p className="text-sm text-gray-500">Compare your rankings against competitors</p>
              </div>
            </div>
            <span className="text-sm text-gray-400 bg-gray-100 px-3 py-1.5 rounded-full">Coming soon</span>
          </div>
